...
const footerLinks = {
  socials: [
    ...
    { label: 'Demander Un Prix', href: siteMeta.emailHref },
    { label: 'WhatsApp', href: siteMeta.whatsappHref },
  ],
  contact: [siteMeta.email, siteMeta.phoneDisplay],
  locations: ['Motos', 'Accessoires', 'Pièces']
};
      ...
      <div className="max-w-3xl relative z-10">
        ...
        <FadeIn>
          <h2 className="text-5xl md:text-6xl lg:text-8xl font-black uppercase tracking-tighter leading-none mb-10">
            Votre Moto <br/> Commence Ici.
          </h2>
          <p className="text-xl text-gray-400 max-w-md mb-10">
            Appel direct, WhatsApp ou demande de prix pour un E-Bike Électrique, un pack ou des accessoires.
          </p>
          <a 
