  ...
  return (
    <>
      <SeoHead
        ...
        description="Politique de confidentialité du site Go Black Motors."
      />
      <SiteLayout>
        <section className="px-4 md:px-10 pt-36 pb-24 max-w-4xl">
          ...
          <div className="space-y-6 text-gray-300 leading-relaxed text-lg">
            ...
            <p>Vous pouvez demander la suppression ou la rectification de vos informations en écrivant à contact@goblackmotors.com.</p>
          </div>
        </section>
      </SiteLayout>
    </>
